...
CREATE POLICY "Authenticated users can touch order-items" ON "public"."order_items" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "Authenticated users can touch orders" ON "public"."orders" TO "authenticated" USING (true) WITH CHECK (true);
